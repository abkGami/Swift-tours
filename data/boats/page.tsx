export const boats = [
  ...
  // o
  {
    ...
    exp: "Full day boat trip",
    features: [
      "Spacious cockpit with twin wheels",
      "Modern sail plan for easy handling",
  ...
  },
  {
    ...
    exp: "Romantic sunset boat trip",
    features: [
      "Large saloon for comfortable living",
      "3 double cabins + saloon berths",
