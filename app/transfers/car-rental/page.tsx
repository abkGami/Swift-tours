...
export default function CarRentalPage() {
  ...
  const [contactForm, setContactForm] = useState({
    ...
    const carRentals: CarRental[] = [
        ...
        // STANDARD RENTAL VEHICLES (7 cars - popular rental fleet staples)
    {
      id: 18,
      name: "Toyota Camry",
      brand: "Toyota",
      ...
      features: ["Toyota Safety Sense", "Fuel Efficient", "Comfortable Seating", "Apple CarPlay", "Spacious Trunk"],
      rating: 4.4,
      fuelType: "Gasoline",
      year: 2024,
      description: "America's best-selling sedan with proven reliability"
    },
    {
      id: 19,
      name: "Nissan Altima",
      ...
      features: ["ProPILOT Assist", "Intelligent AWD", "Zero Gravity Seats", "Remote Engine Start", "Advanced Safety"],
      rating: 4.3,
      fuelType: "Gasoline",
      year: 2024,
      description: "Comfortable midsize sedan with advanced driver assistance"
    },
    {
      id: 20,
      name: "Honda CR-V",
      ...
      features: ["Honda Sensing", "Real Time AWD", "Cargo Space", "Fuel Economy", "Versatile Seating"],
      rating: 4.5,
      fuelType: "Gasoline",
      year: 2024,
      description: "Popular compact SUV combining efficiency with practicality"
    },
    {
      id: 21,
      name: "Toyota RAV4",
      ...
      features: ["AWD", "Toyota Safety Sense", "Adventure Ready", "Cargo Capacity", "Ground Clearance"],
      rating: 4.4,
      fuelType: "Gasoline",
      year: 2024,
      description: "Versatile compact SUV perfect for any adventure"
    },
    {
      id: 22,
      ...
      transmission: "CVT",
      price: "$38/day",
      image: "/cars/chevrolet-malibu.jpg",
      features: ["Chevy Safety Assist", "MyLink Infotainment", "Fuel Efficient", "Spacious Interior", "Trunk Space"],
      rating: 4.1,
      fuelType: "Gasoline",
      year: 2024,
      description: "Well-equipped midsize sedan with modern amenities"
    },
    {
      id: 23,
      ...
      features: ["SmartSense Safety", "Digital Cockpit", "Wireless Charging", "Blue Link Connected Services", "Fuel Economy"],
      rating: 4.3,
      fuelType: "Gasoline",
      year: 2024,
      description: "Stylish compact sedan with advanced technology features"
    },
    {
      id: 24,
      name: "Kia Forte",
      ...
      transmission: "CVT",
      price: "$33/day",
      image: "/cars/kia-forte.jpg",
      features: ["Drive Wise Safety", "UVO Intelligence", "Smartphone Integration", "Fuel Efficiency", "Warranty Coverage"],
      rating: 4.2,
      fuelType: "Gasoline",
      year: 2024,
      description: "Value-packed compact sedan with comprehensive warranty"
    },
    // ELECTRIC VEHICLES (6 cars)
    {
      id: 1,
      name: "Tesla Model 3",
      brand: "Tesla",
      ...
      features: ["Autopilot", "Supercharging Network", "Premium Interior", "Mobile Connectivity", "Over-the-Air Updates"],
      rating: 4.8,
      fuelType: "Electric",
      year: 2024,
      description: "Premium electric sedan with cutting-edge autonomous technology"
    },
    {
      id: 2,
      name: "Nissan Leaf",
      ...
      features: ["e-Pedal", "ProPILOT Assist", "Quick Charging", "Climate Control", "Safety Shield"],
      rating: 4.4,
      fuelType: "Electric",
      year: 2024,
      description: "Reliable electric car perfect for eco-conscious city driving"
    },
    {
      id: 3,
      ...
      transmission: "Automatic",
      price: "$55/day",
      image: "/cars/volkswagen-id4.jpg",
      features: ["Fast Charging", "AWD Available", "Spacious Interior", "Digital Cockpit", "Travel Assist"],
      rating: 4.5,
      fuelType: "Electric",
      year: 2024,
      description: "Versatile electric SUV ideal for family road trips"
    },
    {
      id: 4,
      ...
      transmission: "Automatic",
      price: "$58/day",
      image: "/cars/hyundai-ioniq.jpg",
      features: ["Ultra-Fast Charging", "Vehicle-to-Load", "Panoramic Sunroof", "Digital Side Mirrors", "Smart Cruise Control"],
      rating: 4.7,
      fuelType: "Electric",
      year: 2024,
      description: "Futuristic electric SUV with innovative charging capabilities"
    },
    // {
    //   id: 5,
    //   name: "BMW iX3",
    ...
    //   transmission: "Automatic",
    //   price: "$68/day",
    //   image: "/cars/bmw-ix3.jpg",
    //   features: ["xDrive AWD", "BMW iDrive", "Adaptive Suspension", "Premium Sound", "Wireless Charging"],
    //   rating: 4.6,
    //   fuelType: "Electric",
    //   year: 2024,
    //   description: "Luxury electric SUV combining performance with sustainability"
    // },
    {
      id: 6,
      name: "Kia EV6",
      ...
      features: ["800V Fast Charging", "AWD", "Ambient Lighting", "Wireless Phone Charging", "Highway Driving Assist"],
      rating: 4.5,
      fuelType: "Electric",
      year: 2024,
      description: "Stylish electric crossover with impressive charging speed"
    },

    // COMPACT VEHICLES (6 cars)
    {
      id: 7,
      name: "Toyota Yaris",
      brand: "Toyota",
      ...
      features: ["Fuel Efficient", "Toyota Safety Sense", "Compact Design", "Easy Parking", "Bluetooth"],
      rating: 4.2,
      fuelType: "Gasoline",
      year: 2024,
      description: "Economical compact car perfect for city navigation"
    },
    {
      id: 8,
      name: "Honda Fit",
      ...
      features: ["Magic Seats", "Honda Sensing", "Cargo Flexibility", "Fuel Economy", "Easy Maneuverability"],
      rating: 4.3,
      fuelType: "Gasoline",
      year: 2024,
      description: "Versatile subcompact with clever interior space solutions"
    },
    {
      id: 9,
      name: "Nissan Versa",
      ...
      transmission: "CVT",
      price: "$32/day",
      image: "/cars/nissan-versa.jpg",
      features: ["Spacious Interior", "Advanced Safety", "Apple CarPlay", "Fuel Efficient", "Comfortable Seating"],
      rating: 4.1,
      fuelType: "Gasoline",
      year: 2024,
      description: "Affordable compact sedan with surprising interior space"
    },
    {
      id: 10,
      name: "Hyundai Accent",
      ...
      features: ["SmartSense Safety", "Android Auto", "Fuel Economy", "Warranty Coverage", "Split-Folding Seats"],
      rating: 4.0,
      fuelType: "Gasoline",
      year: 2024,
      description: "Reliable compact sedan with excellent value proposition"
    },
    {
      id: 11,
      ...
      transmission: "CVT",
      price: "$26/day",
      image: "/cars/mitsubishi-mirage.jpg",
      features: ["Ultra Fuel Efficient", "Compact Size", "Easy Parking", "Smartphone Integration", "Lightweight"],
      rating: 3.8,
      fuelType: "Gasoline",
      year: 2024,
      description: "Ultra-efficient city car ideal for tight urban spaces"
    },
    {
      id: 12,
      name: "Kia Rio",
      ...
      features: ["Drive Wise Safety", "UVO Infotainment", "Fuel Economy", "Comfortable Interior", "Trunk Space"],
      rating: 4.1,
      fuelType: "Gasoline",
      year: 2024,
      description: "Well-equipped compact sedan with modern technology"
    },

    // HEAVY/OFF-ROAD VEHICLES (5 cars)
    {
      id: 13,
      name: "Jeep Wrangler",
      brand: "Jeep",
      ...
      features: ["4x4 Capability", "Removable Doors", "Rock-Trac 4WD", "Skid Plates", "Trail Rated"],
      rating: 4.5,
      fuelType: "Gasoline",
      year: 2024,
      description: "Legendary off-road vehicle for extreme adventure terrain"
    },
    {
      id: 14,
      name: "Toyota 4Runner",
      ...
      transmission: "Automatic",
      price: "$85/day",
      image: "/cars/toyota-4runner.jpg",
      features: ["Multi-Terrain Select", "Crawl Control", "Kinetic Dynamic Suspension", "Skid Plates", "Hill Start Assist"],
      rating: 4.6,
      fuelType: "Gasoline",
      year: 2024,
    ...
    },
    {
      ...
      transmission: "Manual",
      price: "$80/day",
      image: "/cars/ford-bronco.jpg",
      features: ["Advanced 4x4", "Terrain Management", "Removable Doors", "Rock Crawl Mode", "Bash Plates"],
      rating: 4.4,
      fuelType: "Gasoline",
      year: 2024,
      description: "Modern off-road icon designed for wilderness exploration"
    },
    {
      id: 16,
      ...
      features: ["4WD", "Towing Package", "Third Row Seating", "Cargo Management", "Advanced Safety"],
      rating: 4.3,
      fuelType: "Gasoline",
      year: 2024,
      description: "Full-size SUV perfect for large groups and heavy cargo"
    },
    {
      id: 17,
      name: "Nissan Armada",
      ...
      transmission: "Automatic",
      price: "$90/day",
      image: "/cars/nissan-armada.jpg",
      features: ["Intelligent 4WD", "Tow Mode", "Around View Monitor", "Tri-Zone Climate", "Power Liftgate"],
      rating: 4.2,
      fuelType: "Gasoline",
      year: 2024,
      description: "Spacious full-size SUV ideal for family road trips"
    },
