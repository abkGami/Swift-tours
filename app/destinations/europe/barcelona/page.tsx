...
const barcelonaAttractions = [
  {
    ...
    duration: "2-3 hours",
    category: "Landmark",
    highlights: ["Stunning Architecture", "Gaudí's Masterpiece", "Beautiful Facades"],
  },
  {
    name: "Park Güell",
    description: "Colorful park with artistic structures",
    image: "/placeholder.svg?height=300&width=400",
    rating: 4.8,
    duration: "2-4 hours",
    category: "Park",
    highlights: ["Mosaic Art", "Gaudí's Designs", "Panoramic Views"],
  },
  {
    name: "La Rambla",
    description: "Famous street known for shopping and dining",
    image: "/placeholder.svg?height=300&width=400",
    rating: 4.7,
    duration: "1-2 hours",
    category: "Shopping",
    highlights: ["Street Performers", "Local Cuisine", "Historic Buildings"],
  },
  {
    name: "Casa Batlló",
    description: "Modernist building with unique architecture",
    image: "/placeholder.svg?height=300&width=400",
    rating: 4.6,
    duration: "1-2 hours",
    category: "Museum",
    highlights: ["Gaudí's Design", "Colorful Facades", "Artistic Interiors"],
  },
  {
    ...
    duration: "3-5 hours",
    category: "Beach",
    highlights: ["Sunbathing", "Beach Bars", "Water Sports"],
  },
  {
    ...
    highlights: ["Castle Tours", "Scenic Views", "Cultural Events"],
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the most iconic landmarks and hidden gems that make Barcelona
              the world's most visited city
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {barcelonaAttractions.map((attraction, index) => (
              <motion.div
                key={attraction.name}
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
                Book your Barcelona adventure today and experience the magic of the
