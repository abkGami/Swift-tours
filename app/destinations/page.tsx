  ...
  },
  {
    ...
    destinations: [
      ...
      },
      {
        ...
        rating: 4.9,
        highlights: ["Maasai Mara", "Nairobi National Park", "Diani Beach"],
        href: "/destinations/africa/kenya",
      },
      {
        name: "South Africa",
        description: "Diverse wildlife, vibrant cities, and scenic coastlines",
        rating: 4.9,
        highlights: ["Table Mountain", "Kruger Park", "Cape Town"],
      ...
      {
        name: "Tanzania",
        description: "Legendary safaris, Mount Kilimanjaro, and Zanzibar beaches",
        rating: 4.8,
      ...
      },
      {
        ...
        rating: 4.7,
        highlights: ["El Jem", "Sidi Bou Said", "Sahara Desert"],
