...
const thailandCities = [
  {
    name: "Bangkok",
    description:
      "Thailand's bustling capital, filled with ornate shrines, vibrant street life, and bustling markets.",
  ...
  },
  {
    name: "Chiang Mai",
    description:
      "A cultural gem in Northern Thailand known for temples, mountains, and lantern festivals.",
    image: "/images/chiangmai.jpg",
    rating: 4.7,
    duration: "2-3 days",
    category: "Cultural Haven",
    highlights: [
  ...
  },
  {
    name: "Phuket",
    description:
      "Thailand's largest island, offering pristine beaches, vibrant nightlife, and water adventures.",
...
const thailandAttractions = [
  {
    name: "Grand Palace",
    description:
      "The most famous landmark in Bangkok, a must-see for first-time visitors.",
    image: "/images/grandpalace.jpg",
  },
  {
    name: "Phi Phi Islands",
    description:
      "Iconic island group famous for turquoise waters and dramatic cliffs.",
    image: "/images/phiphi.jpg",
  },
  {
    name: "Wat Arun",
    description:
      "Temple of Dawn located on the west bank of the Chao Phraya River.",
    image: "/images/watarun.jpg",
  },
  {
    name: "Doi Suthep",
    description: "A mountaintop temple offering panoramic views of Chiang Mai.",
    image: "/images/doisuthep.jpg",
  },
  {
    name: "Floating Market",
    description: "Traditional Thai market where vendors sell goods from boats.",
    image: "/images/floatingmarket.jpg",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-orange-50">
      ...
      <section className="pt-24 pb-10 relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-900/70 to-pink-900/70" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Thailand</h1>
            <p className="text-xl text-yellow-100 max-w-3xl mx-auto mb-8">
              From golden temples to tropical beaches, Thailand is an adventure
              waiting to unfold.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore Thailand's top cities for adventure, culture, and
              relaxation.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {thailandCities.map((attraction, index) => (
              <motion.div
                key={attraction.name}
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
            {thailandAttractions.map((attraction, index) => (
              <motion.div
                key={attraction.name}
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="bg-gradient-to-r from-orange-600 to-yellow-500 rounded-2xl p-8 text-white">
              ...
              <p className="text-yellow-100 mb-6 max-w-2xl mx-auto">
                Discover temples, beaches, and unforgettable adventures in the
                Land of Smiles.
              </p>
